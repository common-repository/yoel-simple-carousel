...
function yoel_carousel_activation_function()
{


}
register_activation_hook( __FILE__, 'yoel_carousel_activation_function' );
...
function my_coverflow_enqueue_yoel_carousels() {
...
add_action( 'wp_enqueue_scripts', 'my_coverflow_enqueue_yoel_carousels' );
